...
int main(void) {
    ...
    adicionarPergunta(&head, ". Por que a Igrejinha de Piedade é considerada ponto\n\n crítico para incidentes com tubarões?", " a) Pela poluição da água", " b) Devido à abertura nos arrecifes", " c) Por causa da pesca excessiva", 'B', 30);
    adicionarPergunta(&head, ". Que medidas as autoridades têm tomado para lidar\n\n com os ataques de tubarão nas praias perto\n\n da Igrejinha de Piedade?", " a) Aumentar a fiscalização", " b) Proibir o banho de mar", " c) Construir barreiras", 'A', 30);
    adicionarPergunta(&head, ". Qual é a relevância da Igrejinha de Piedade no\n\n contexto histórico e social de Pernambuco?", " a) É um ponto de referência para turistas apenas", " b) Está ligada ao ciclo da cana-de-açúcar", " c) Não possui relevância histórica", 'B', 30);
    adicionarPergunta(&head, ". Qual foi a ação recomendada por especialistas em\n\n resposta ao aumento de ataques de tubarão\n\n em Piedade?", " a) Construir barreiras no mar", " b) Implantar restrições de banho em áreas de risco", " c) Organizar campanhas de conscientização", 'B', 30);
    adicionarPergunta(&head, ". Em que ano a Igrejinha de Piedade foi tombada como\n\n patrimônio histórico?", " a) 1938", " b) 1975", " c) 1986", 'A', 40);
    adicionarPergunta(&head, ". Qual é a denominação religiosa da Igrejinha de Piedade?", " a) Católica", " b) Protestante", " c) Ortodoxa", 'A', 30);
    adicionarPergunta(&head, ". Em que estilo arquitetônico predomina a Igrejinha de\n\n Piedade?", " a) Gótico", " b) Barroco", " c) Colonial", 'C', 30);
    adicionarPergunta(&head, ". Qual evento histórico está associado à construção da\n\n Igrejinha de Piedade?", " a) Primeira Missa no Brasil", " b) Ciclo do Ouro", " c) Ciclo da Cana-de-Açúcar", 'C', 30);
    adicionarPergunta(&head, ". Qual elemento natural próximo aumenta o risco de\n\n ataques de tubarão na área?", " a) Falta de arrecifes", " b) Abertura nos arrecifes", " c) Corais grandes", 'B', 30);
    adicionarPergunta(&head, ". A Igrejinha de Piedade é um ponto de referência para\n\n qual tipo de visitante?", " a) Pescadores locais", " b) Turistas e historiadores", " c) Apenas religiosos", 'B', 30);
    adicionarPergunta(&head, ". Qual fator ambiental agravou o risco de ataques de\n\n tubarão nas proximidades?", " a) Pesca predatória", " b) Construção de portos", " c) Falta de fiscalização", 'B', 40);
    adicionarPergunta(&head, ". Qual dos seguintes eventos é comum próximo à Igrejinha\n\n de Piedade?", " a) Romarias religiosas", " b) Competições de surfe", " c) Corridas de barco", 'A', 30);
    adicionarPergunta(&head, ". Qual é o principal material utilizado na construção da\n\n Igrejinha de Piedade?", " a) Concreto armado", " b) Pedra calcária", " c) Madeira", 'B', 30);
    adicionarPergunta(&head, ". Quem é a santa homenageada pela Igrejinha de Piedade?", " a) Santa Luzia", " b) Nossa Senhora da Piedade", " c) Santa Clara", 'B', 30);
    adicionarPergunta(&head, ". Qual é o papel cultural da Igrejinha de Piedade para a\n\n comunidade local?", " a) Apenas lugar de culto", " b) Ponto turístico e histórico", " c) Local para casamentos", 'B', 30);
    adicionarPergunta(&head, ". A presença de quais espécies de tubarão é mais comum\n\n na área de Piedade?", " a) Tubarão-tigre", " b) Tubarão-lixa", " c) Tubarão-martelo", 'A', 40);
    adicionarPergunta(&head, ". Qual ação é desencorajada pelos locais devido ao risco\n\n de tubarões?", " a) Nadar em águas profundas", " b) Pescar próximo à costa", " c) Fazer mergulho", 'A', 30);
    adicionarPergunta(&head, ". Qual é o nome da praia onde a Igrejinha de Piedade está\n\n localizada?", " a) Praia de Boa Viagem", " b) Praia de Piedade", " c) Praia do Paiva", 'B', 30);
    adicionarPergunta(&head, ". Qual organização é responsável pela preservação da\n\n Igrejinha de Piedade?", " a) IPHAN", " b) IBAMA", " c) UNESCO", 'A', 30);
    adicionarPergunta(&head, ". Quais ações foram sugeridas para reduzir o impacto\n\n ambiental na região da Igrejinha?", " a) Plantio de árvores", " b) Redução do turismo", " c) Construção de barreiras artificiais", 'C', 30);
    adicionarPergunta(&head, ". A construção da Igrejinha de Piedade foi inspirada em\n\n qual estilo europeu?", " a) Italiano", " b) Espanhol", " c) Português", 'C', 40);
    adicionarPergunta(&head, ". Qual é uma das tradições religiosas que ocorrem na\n\n Igrejinha de Piedade?", " a) Festa do Divino", " b) Festa da Padroeira", " c) Círio de Nazaré", 'B', 30);
    adicionarPergunta(&head, ". Qual o tipo de solo que cerca a área da Igrejinha de Piedade?", " a) Areia e argila", " b) Pedra calcária", " c) Basalto", 'A', 30);
    adicionarPergunta(&head, ". Qual característica torna a Igrejinha de Piedade única na região?", " a) Estilo arquitetônico incomum", " b) Construção em área urbana", " c) Construída sobre um penhasco", 'A', 40);
